...
class ProbePreprocessor(Preprocesser):
    ...
    def readDataset(self, suffix = "", hasTrain = True):
        dataset = {"train": None, "evalTrain": None, "val": None, "test": None, "probeAND2":None, "probeOR2":None}
        if hasTrain:
    ...
    def prepareData(self, data, train, filterKey = None, noBucket = False):
        ...
        filters = {"train": filterTrain, "evalTrain": filterTrain,
                   "val": filterVal, "test": filterDefault, "probeAND2": filterDefault, "probeOR2": filterDefault}
        ...
        if filterKey in {"probeAND2", "probeOR2"}:
            num = 0
